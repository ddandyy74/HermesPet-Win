...
> 最后更新：2026-06-07 | 当前阶段：M1 核心框架 | 进度：31%
...
| ID | 任务 | 状态 | 备注 |
|----|------|------|------|
| M2.2.1 | 悬停展开动画（300ms CubicEase EaseOut） | ⬜ | WPF Storyboard |
| M2.2.2 | 流式传输脉冲动画 | ⬜ | |
| M2.2.3 | 错误状态红色闪烁 | ⬜ | |
| M2.2.4 | 状态切换 transition | ⬜ | |
...
| M2.3.2 | `Windows/PetWindow.cs` 逻辑 | - | ⬜ | DragMove + 点击穿透 |
...
| ID | 任务 | 状态 | 备注 |
|----|------|------|------|
| M2.4.1 | 宠物台词数据集 | ⬜ | 每条台词含角色/AI 模式关联 |
| M2.4.2 | 宠物 ↔ 动态岛联动 | ⬜ | 状态传播 |
| M2.4.3 | 宠物位置不遮挡逻辑 | ⬜ | |
